<?php
if (!isset($_COOKIE['labs-ehackify'])) {
	setcookie('labs-ehackify', 'labs-ehackify', time() + (86400 * 30), "/",null,null,true);
	header("Refresh:0");
}
?>
<!DOCTYPE html>
...
if (isset($_COOKIE['labs-ehackify'])) {
    ...
    echo "<br><span style=\"font-size:1em;\">Current value supplied by <b>labs-ehackify</b> cookie is: </span><br>" . (string)$_COOKIE['labs-ehackify'] . '';
