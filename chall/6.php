...
<script>
if (localStorage.getItem("labs-ehackify") === null) {
	 localStorage.setItem("labs-ehackify", "labs-ehackify");
}
</script>
  </head>
  <body>
...
<!-- partial -->
  ...
  <script>
if (localStorage.getItem("labs-ehackify") !== null) {
		 document.getElementById("content").innerHTML = "<span>Current value of <b>labs-ehackify</b> LocalStorage is: </span>" + localStorage.getItem("labs-ehackify") + "";
}
</script>
</body>
</html>
